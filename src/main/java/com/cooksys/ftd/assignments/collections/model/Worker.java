...
public class Worker implements Employee {
    ...
    public List<Manager> getChainOfCommand() {
        Manager workersManagers = getManager();
        
        List<Manager> listOfWorkersManangers = new ArrayList<>();
        
        while (workersManagers != null) {
			listOfWorkersManangers.add(workersManagers);
			workersManagers = workersManagers.getManager();		}
        
		return listOfWorkersManangers;
    }
